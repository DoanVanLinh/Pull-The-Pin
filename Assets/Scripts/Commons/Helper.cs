...
public static class Helper
{
    ...
    public static string Current_Delay_Shot_Level_Key = "CurrentDelayShotLevel1";
    public static string Current_GameMode_Key = "CurrentGameMode1";
    public static string Current_Noads_Reward_Key = "CurrentNoadsReward1";
    public static string Current_Theme_Key = "CurrentTheme1";
    public static string Current_Rank_Key = "CurrentRank1";
    public static string Current_Height_Key = "CurrentHeight1";
    ...
    public static string Current_Weapon_Key = "CurrentBall1";
    public static string Current_Character_Key = "CurrentCharacter1";
    public static string Current_Key_Reward_Key = "CurrentKeyReward1";
    public static string Current_Coin_Upgrade_Key = "CurrentCoinUpgrade1";
    public static string Current_Hp_Upgrade_Key = "CurrentHpUpgrade1";
    public static string Current_Damage_Upgrade_Key = "CurrentDamageUpgrade1";
    public static string Current_Revive_Time_Key = "CurrentReviveTime1";
    public static string Current_Zone_Key = "CurrentZone1";
    public static string Max_Zone_Key = "MaxZone1";
    public static string Current_Slot_Item_Key = "CurrentSlotItem1";
    public static string Current_Count_Play_Key = "CurrentCountPlay1";
    public static string Is_No_Ads_Key = "NoAds1";
    public static string Is_Tut_Level_Up_Key = "TutLevelUp1";
    public static string Is_Tut_Circle_fire_Key = "TutCircleFire1";
    public static string Interval_Common_Item_Key = "IntervalCommonItem1";
    public static string Interval_Immortal_Item_Key = "IntervalImortalItem1";
